...
filePrefix = dirName+"trash/seqframe/summary/seqframe_"
multiplexFile = "/mit/jmjenson/Sort_Data/140828_XMF_Combined_Sortcery_ReSeq/140828Kea/D14-3934-1111S/fulldnaseqs/multiplex_assignments_Vincent2"
numBarcodes1 = 24;
numBarcodes2 = 7;
        ...
        for experiment in myDataAssignments:
            ...
            with open(dirName+experiment+"/cell_counts_seqframe_"+str(bg),'w') as countStream, open(dirName+experiment+"/unique_seqs_seqframe_"+str(bg),'w') as seqStream:
                for index, each in myExperiment.iterrows():
                    ...
                    countStream.write("\n")
            myExperiment.toPickle(dirName+experiment+"/rawCounts.pickle")
